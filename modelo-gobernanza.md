...
Se entregará el marco de gobernanza del Espacio de datos que incluirá el conjunto de principios, normas, políticas (reglas/reglamentos), acuerdos y prácticas que se aplican a la gobernanza, la gestión y las operaciones de intercambio de datos que se realizarán en el Espacio de datos.

El modelo de gobernanza consiste en:

- **Rulebook (Reglamento)** del Espacio de datos y código ético.
- **Políticas de gestión del ciclo de vida del dato** (modelos de políticas).
- **Plan de Escalado de Participantes.**

---

## Criterios de aceptación del entregable

El marco de gobernanza deberá incluir los siguientes documentos:

- Libro de Reglas "Rulebook" (Reglamento) del Espacio de datos y código ético.
- Modelos de Políticas.
- Plan de Escalado de Participantes.

---

## Requisitos vinculados (R)

| ID  | Nombre | Descripción | Criterios de aceptación |
|-----|--------|-------------|-------------------------|
| R1  | Aceptación del marco de gobernanza | Verificar que la documentación del marco de gobernanza es completa, precisa, consistente y coherente con los objetivos del Espacio de Datos. | Rulebook y Código Ético: apartados especificados en sección 3.2 del documento de proyecto. Políticas: requisitos de participación y autenticación, normas para acceso/uso/intercambio de datos, procedimientos resolución de disputas y gestión de incumplimientos. Plan de Escalado: detallar en forma de "proceso" la incorporación de nuevos participantes. |
...
| ID | Nombre | Fechas |
|----|--------|--------|
| A1.1 | Diseño del marco de gobernanza | 01/11/2024 – 31/12/2024 |
| A1.2 | Gestión y Supervisión del marco de Gobernanza | 01/01/2025 – 31/12/2025 |

> **Nota de la copia publicada.** El desglose presupuestario por actividad y la
> entidad ejecutora de cada una no se reproducen aquí: son metadatos de gestión
> del proyecto, no contenido normativo, y su difusión corresponde a cada entidad.
> Constan en la versión entregada del documento.

---

## Checklist de cumplimiento

- [x] Rulebook publicado con todos los apartados de la sección 3.2.
- [x] **Código ético** — «E1.Código Ético y de Conducta.pdf», aprobado en el acta 1/2026; publicación condicionada a la revisión jurídica del acuerdo 9.
- [x] Modelos de políticas publicados (participación, acceso/uso/intercambio, disputas, incumplimientos).
- [x] **Modelos de política de acceso** publicados — «E1.Plantillas de política ODRL.pdf» (OPEN, RESEARCH-ONLY, COMMERCIAL-WITH-OBLIGATIONS).
- [x] **Políticas de gestión del ciclo de vida del dato** — «E1.Políticas de gestión del ciclo de vida del dato.pdf», aprobadas en el acta 1/2026; retención y SLA de borrado fijados en los acuerdos 2 y 3.
- [x] **Plan de comunicación a participantes** (A1.2) — «E1.Plan de Comunicación a Participantes.pdf», aprobado en el acta 1/2026; plazos, repositorio y responsable fijados en los acuerdos 4, 5 y 6.
- [x] Plan de Escalado de Participantes documentado como proceso (Procedimiento de Adhesión §4).
- [x] Revisión de completitud, precisión y coherencia con objetivos del Espacio de Datos.
